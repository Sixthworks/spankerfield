...
struct ImColor
{
    ...
    static ImColor Cyan(int a = 255) { return (ImColor(0, 255, 255, a)); }
    static ImColor Pink(int a = 255) { return (ImColor(255, 0, 255, a)); }
    static ImColor Black(int a = 255) { return (ImColor(0, 0, 0, a)); }
    static ImColor Grey(int a = 255) { return (ImColor(127, 127, 127, a)); }
    static ImColor White(int a = 255) { return (ImColor(255, 255, 255, a)); }
    static ImColor Red(int a = 255) { return (ImColor(255, 0, 0, a)); }
    static ImColor Green(int a = 255) { return (ImColor(0, 255, 0, a)); }
    static ImColor Blue(int a = 255) { return (ImColor(0, 0, 255, a)); }
    static ImColor Yellow(int a = 255) { return (ImColor(255, 255, 0, a)); }
    static ImColor Purple(int a = 255) { return (ImColor(128, 0, 255, a)); }
    static ImColor Orange(int a = 255) { return (ImColor(255, 128, 0, a)); }
